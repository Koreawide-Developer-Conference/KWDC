...
export const OverviewSection: React.FC<LangProps> = async ({ params }) => {
  ...
  return (
    <section
      className='flex flex-col items-center justify-center w-screen max-lg:py-14 relative text-black px-4 bg-white'
      id='overview'
    >
      <div className='max-w-[1440px] max-lg:px-0 lg:px-20 min-h-screen w-full flex flex-col items-center justify-center text-center'>
        ...
        <div className='mt-20 bg-brightGreen-50 rounded-[28px] py-12 lg:px-20 grid grid-cols-3 gap-10 max-lg:grid-cols-1 max-lg:pl-5'>
